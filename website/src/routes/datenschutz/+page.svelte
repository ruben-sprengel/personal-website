...
<section class="mx-auto min-h-screen w-full max-w-4xl px-4 py-16">
	...
	<h2 class="p-2 text-3xl">1. Datenschutz auf einen Blick</h2>

	<h3 class="p-2 text-2xl">Allgemeine Hinweise</h3>
	<p class="p-2">
	...
	<h3 class="p-2 text-2xl">Datenerfassung auf dieser Website</h3>
	...
	<h4 class="p-2 text-xl">Wie erfassen wir Ihre Daten?</h4>
	<p class="p-2">
	...
	<h4 class="p-2 text-xl">Wof&uuml;r nutzen wir Ihre Daten?</h4>
	<p class="p-2">
	...
	<h4 class="p-2 text-xl">Welche Rechte haben Sie bez&uuml;glich Ihrer Daten?</h4>
	<p class="p-2">
	...
	<h3 class="p-2 text-2xl">Analyse-Tools und Tools von Dritt&shy;anbietern</h3>
	<p class="p-2">
	...
	<h2 class="p-2 text-3xl">2. Hosting</h2>
	<p>Wir hosten die Inhalte unserer Website bei folgendem Anbieter:</p>
	<h3 class="p-2 text-2xl">Hetzner</h3>
	<p class="p-2">
	...
	<h2 class="p-2 text-3xl">3. Allgemeine Hinweise und Pflicht&shy;informationen</h2>
	<h3 class="p-2 text-2xl">Datenschutz</h3>
	<p class="p-2">
	...
	<h3 class="p-2 text-2xl">Hinweis zur verantwortlichen Stelle</h3>
	<p class="p-2">
	...
	<h3 class="p-2 text-2xl">Speicherdauer</h3>
	<p class="p-2">
	...
	<h3 class="p-2 text-2xl">Empf&auml;nger von personenbezogenen Daten</h3>
	<p class="p-2">
	...
	<h3 class="p-2 text-2xl">Widerruf Ihrer Einwilligung zur Datenverarbeitung</h3>
	<p class="p-2">
	...
	<h3 class="p-2 text-2xl">Recht auf Daten&shy;&uuml;bertrag&shy;barkeit</h3>
	<p class="p-2">
	...
	<h3 class="p-2 text-2xl">Auskunft, Berichtigung und L&ouml;schung</h3>
	<p class="p-2">
	...
	<h3 class="p-2 text-2xl">Recht auf Einschr&auml;nkung der Verarbeitung</h3>
	<p class="p-2">
	...
	<h3 class="p-2 text-2xl">SSL- bzw. TLS-Verschl&uuml;sselung</h3>
	<p class="p-2">
	...
	<!--	<h2 class="text-3xl p-2">4. Datenerfassung auf dieser Website</h2>-->
	...
	<!--		Datenschutzerkl&auml;rung entnehmen.-->
	<!--	</p>-->
	<h3 class="p-2 text-2xl">Server-Log-Dateien</h3>
	<p class="p-2">
	...
	<h3 class="p-2 text-2xl">Anfrage per E-Mail, Telefon oder Telefax</h3>
	<p class="p-2">
	...
	<!--	<h3 class="text-2xl">Matomo</h3>-->
	<!--	<p>Diese Website benutzt den Open Source Webanalysedienst Matomo.</p>-->
	<!--	<p>-->
	<!--		Mit Hilfe von Matomo sind wir in der Lage Daten &uuml;ber die Nutzung unserer Website durch die-->
	...
	<!--		Aktionen durchf&uuml;hren (z.&nbsp;B. Klicks, K&auml;ufe u. &Auml;.).-->
	<!--	</p>-->
	<!--	<p>-->
	...
	<!--		lit. a DSGVO und &sect; 25 Abs. 1 TDDDG, soweit die Einwilligung die Speicherung von Cookies-->
	...
	<!--	</p>-->
	<h4 class="p-2 text-xl">Hosting</h4>
	<p class="p-2">
		Wir hosten Matomo ausschlie&szlig;lich auf unseren eigenen Servern, sodass alle Analysedaten bei
		uns verbleiben und nicht weitergegeben werden.
	</p>
	<p class="p-2">Quelle: <a href="https://www.e-recht24.de">https://www.e-recht24.de</a></p>
</section>
